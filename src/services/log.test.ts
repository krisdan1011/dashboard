...
describe("log service", function () {
    describe("getLogs", function () {
        // Mock fetch
        beforeEach(function () {
            fetchMock.get(/https:\/\/(logless|logless-hyper).bespoken.tools\/v1\/query\?*/, {
                "data": dummyLogs(2)
            });
        });
    ...
    describe("TimeSummary", function () {
        ...
        before(function () {
            ...
            fetchMock.get(/https:\/\/(logless|logless-hyper).bespoken.tools\/v1\/timeSummary\?*/, mockSummary);
        });
    ...
    describe("IntentSummary", function () {
        ...
        before(function () {
            ...
            fetchMock.get(/https:\/\/(logless|logless-hyper).bespoken.tools\/v1\/intentCount\?*/, mockSummary);
        });
    ...
    describe("SourceStats", function () {
        ...
        before(function () {
            ...
            fetchMock.get(/https:\/\/(logless|logless-hyper).bespoken.tools\/v1\/sourceStats\?*/, mockSummary);
        });
